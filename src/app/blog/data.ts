export const blogPosts = [
    ...
    },
    {
        ...
        excerpt: "In a country of 7.8 million people, just 6.4% of Sierra Leone's population has access to an electrical grid. Dr. David Kargbo continues to light the way forward.",
        content: [
