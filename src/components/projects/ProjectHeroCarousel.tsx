    ...
    return (
        <div className={cn("flex flex-col gap-3", className)}>
            <div className="relative w-full overflow-hidden rounded-2xl shadow-xl group">
                ...
                {/* Navigation Buttons (Always visible on mobile, Visible on Hover/Focus on desktop) */}
                <div className="absolute inset-0 pointer-events-none flex items-center justify-between px-4 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">
                    <button
                        onClick={prevSlide}
                        className="pointer-events-auto p-3 rounded-full bg-black/20 backdrop-blur-md border border-white/40 md:border-white/10 text-white hover:bg-white/20 transition-all hover:scale-110 active:scale-95 shadow-md"
            ...
            {onVideoClick && (
                <div className="flex justify-end">
                    <button
                        ...
                        className="flex items-center gap-3 px-6 py-2.5 bg-water text-white font-bold rounded-full hover:bg-water/90 transition-all shadow-md hover:shadow-lg hover:scale-105 group"
                    >
