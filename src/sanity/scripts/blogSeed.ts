...
export const blogSeed: BlogSeedPost[] = [
  {
    title: "Climate change impact on poor farmers in Africa",
    slug: "climate-change-impact-farmers-africa",
    publishedAt: new Date("January 15, 2026").toISOString(),
    author: "EnviroOne Team",
    imageFile: "climate_change_rice_field.jpg",
    imageDir: "blog",
    excerpt:
      "EnviroOne has experienced firsthand the impact of changes in climate on farm yields in Sierra Leone. Learn about the risks and potential adaptation strategies.",
    paragraphs: [
  ...
  {
    title: "Lighting the Way Forward for Sierra Leone",
    slug: "lighting-the-way-forward-sierra-leone",
    publishedAt: new Date("September 5, 2019").toISOString(),
    author: "Solight Design",
    imageFile: "education_1.png",
    imageDir: "projects",
    excerpt:
      "In a country of 7.8 million people, just 6.4% of Sierra Leone's population has access to an electrical grid. Dr. David Kargbo continues to light the way forward.",
    paragraphs: [
